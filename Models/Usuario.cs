...
namespace SistemaControleAlunos.Models
{
    ...
    {
        //5º step
        // cria class usuario que vau monta a tabela usuario no banco, passa validações atravez do DataAnnotations
        // a proprieda virtual vai relacionar tabelas
        [Key]
        ...
        //31º step
        // toda propriedade de relacionamento para web api tera um json ignore 
