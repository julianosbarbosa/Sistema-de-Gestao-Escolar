...
{
    //8º step
    // cria class Notas que vai monta a tabela grupos no banco, passa validações atravez do DataAnnotations
    ...
    public class Notas
    {
        ...
        public virtual GruposDetalhes GrupoDetalhes { get; set; }
