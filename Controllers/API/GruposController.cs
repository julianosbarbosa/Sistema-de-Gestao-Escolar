...
namespace SistemaControleAlunos.Controllers.API
{
    ...
    public class GruposController : ApiController
    {
        ...
        {
            var estudantes = db.GruposDetalheses.Where(gd => gd.GrupoId == grupoId).ToList();
            ...
            foreach (var estudante in estudantes)
            {
                ...
                {
                    GruposDetalhes= estudante.GrupoDetalhesId,
        ...
        {
            var notaDef = 0.0;
            var notas = db.GruposDetalheses.Where(gd => gd.GrupoId == grupoId && gd.UserId == userId).ToList();
        ...
        public IHttpActionResult GetGrupos(int userId)
        {
            ...
            var objetos = db.GruposDetalheses.Where(gd => gd.UserId == userId).ToList();
            ...
            var resposta = new { MateriasProf = grupos, MatriculadoEm = objetos };
            return Ok(resposta);
        }
