...
namespace SistemaControleAlunos.Controllers.MVC
{
    public class NotasController : Controller
    {
        ...
        {
            ViewBag.GrupoDetalhesId = new SelectList(db.GruposDetalheses, "GrupoDetalhesId", "GrupoDetalhesId");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "NotaId,GrupoDetalhesId,Percentual,Nota")] Notas notas)
        {
            ...
            ViewBag.GrupoDetalhesId = new SelectList(db.GruposDetalheses, "GrupoDetalhesId", "GrupoDetalhesId", notas.GrupoDetalhesId);
            return View(notas);
        }
